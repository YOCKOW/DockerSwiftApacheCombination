...
|              | Swift 6.1.3                | Swift 6.2.4                   | Swift 6.3.1                   |
|--------------|----------------------------|-------------------------------|-------------------------------|
| Ubuntu 22.04 | `Swift_6.1.3-jammy-latest` | `Swift_6.2.4-jammy-latest`    | `Swift_6.3.1-jammy-latest`    |
| Ubuntu 24.04 | `Swift_6.1.3-noble-latest` | `Swift_6.2.4-noble-latest`    | `Swift_6.3.1-noble-latest`    |
| Debian 12.12 | n/a                        | `Swift_6.2.4-bookworm-latest` | `Swift_6.3.1-bookworm-latest` |
...
```console
# docker run -it -d --rm -p 60080:80 ghcr.io/yockow/swift-de-cgi:Swift_6.3.1-noble-latest
...
```console
# docker run -it -d --rm -v /path/to/my/web:/home/swifche/web -p 80:80 ghcr.io/yockow/swift-de-cgi:Swift_6.3.1-noble-latest httpd -f /home/swifche/web/httpd.conf
```
