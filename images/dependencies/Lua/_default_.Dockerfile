...
ARG LUA_HASH="57ccc32bbbd005cab75bcc52444052535af691789dba2b9016d5c50640d68b3d"
ARG LUA_INSTALL_PREFIX="/opt/Lua"
ARG LICENSES_DIR="/licenses"

################################################################################
FROM $BASE_OS_IMAGE AS lua-builder
ARG LUA_VERSION
ARG LUA_HASH
...
cat <<_LICENSE_METADATA_ >"${LICENSES_DIR}/metadata/Lua.json"
{
    "name": "Lua",
    "url": "https://lua.org/",
    "version": "${LUA_VERSION}",
    "filenames": {
        "readme.html": "Lua.html"
    }
}
_LICENSE_METADATA_
