...
ENV APACHE_HTTP_SERVER_BIN_URL="${APACHE_DOWNLOAD_WEB_ROOT}/httpd/httpd-${APACHE_HTTP_SERVER_VERSION}.tar.gz" \
    ...
    APACHE_HTTP_SERVER_PGP_KEY_LOCAL_BASENAME="httpd.key" \
    ...
    APACHE_APR_PGP_KEY_LOCAL_BASENAME="apr.key" \
...
RUN wget -q -O "${APACHE_HTTP_SERVER_PGP_KEY_LOCAL_BASENAME}" "$APACHE_HTTP_SERVER_KEYS_URL" \
    && gpg --import "${APACHE_HTTP_SERVER_PGP_KEY_LOCAL_BASENAME}"
RUN wget -q -O "${APACHE_APR_PGP_KEY_LOCAL_BASENAME}" "$APACHE_APR_KEYS_URL" \
    && gpg --import "${APACHE_APR_PGP_KEY_LOCAL_BASENAME}"
...
cat <<_HTTPD_LICENSE_METADATA_ >"${LICENSES_DIR}/metadata/Apache_HTTP_Server.json"
{
    "name": "Apache HTTP Server",
    "url": "https://httpd.apache.org/",
    "version": "${APACHE_HTTP_SERVER_VERSION}",
    "filenames": {
        "LICENSE": "Apache_HTTP_Server-LICENSE.txt",
        "NOTICE": "Apache_HTTP_Server-NOTICE.txt"
    },
    "file_order": [
        "LICENSE",
        "NOTICE"
...
cat <<_APR_LICENSE_METADATA_ >"${LICENSES_DIR}/metadata/Apache_Portable_Runtime.json"
{
    "name": "Apache Portable Runtime",
    "url": "https://apr.apache.org/",
    "version": "${APACHE_APR_VERSION}",
    "filenames": {
        "LICENSE": "Apache_Portable_Runtime-LICENSE.txt",
        "NOTICE": "Apache_Portable_Runtime-NOTICE.txt"
    },
    "file_order": [
        "LICENSE",
        "NOTICE"
...
cat <<_APR_UTIL_LICENSE_METADATA_ >"${LICENSES_DIR}/metadata/Apache_Portable_Runtime_Utility_Library.json"
{
    "name": "Apache Portable Runtime Utility Library",
    "url": "https://apr.apache.org/",
    "version": "${APACHE_APRUTIL_VERSION}",
    "filenames": {
        "LICENSE": "Apache_Portable_Runtime_Utility_Library-LICENSE.txt",
        "NOTICE": "Apache_Portable_Runtime_Utility_Library-NOTICE.txt"
    },
    "file_order": [
        "LICENSE",
        "NOTICE"
