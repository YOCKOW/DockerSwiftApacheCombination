################################################################################
#
# images/dependencies/OpenSSL/Dockerfile
#
# © 2025 YOCKOW.
...
ENV LDFLAGS="-Wl,-rpath,${OPENSSL_INSTALL_PREFIX}/lib,-rpath,${ZLIB_INSTALL_PREFIX}/lib"
RUN perl ./Configure \
...
cp ./LICENSE.txt "${LICENSES_DIR}/OpenSSL.txt"
cat <<_LICENSE_METADATA_ >"${LICENSES_DIR}/metadata/OpenSSL.json"
{
    "name": "OpenSSL",
    "url": "https://openssl-library.org/",
    "version": "${OPENSSL_VERSION}",
    "filenames": {
        "LICENSE.txt": "OpenSSL.txt"
    }
}
_LICENSE_METADATA_
